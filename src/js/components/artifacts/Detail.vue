      ...
      <section class="section-container hero-title">
        <div class="columns is-mobile">
          ...
          >
            <img
              :data-error="
                `${this.assetsUrl}/assets/item_arti/small_missing.jpg`
              "
    ...
    <aside class="column is-two-fifths" v-if="!isLoading && showDetails">
      ...
      <section class="section-container">
        <div class="section-box hero-illustration">
          ...
          <div class="artifact-artwork" v-lazy-container="{ selector: 'img' }">
            <img
              :data-error="
                `${this.assetsUrl}/assets/item_arti/icon_missing.png`
              "
            ...
            <img
              :data-error="
                `${this.assetsUrl}/assets/item_arti/full_missing.png`
              "
      ...
      <section class="section-container">
        <div class="section-box">
          ...
          <p
            :key="loreParagraph"
            v-for="loreParagraph in artifactDetail.loreDescription"
          >
            {{ loreParagraph }}
          </p>
        </div>
...
export default {
  ...
  computed: {
    ...
    imageUrls() {
      return {
        full: `${this.assetsUrl}/assets/item_arti/${
          this.artifactDetail.fileId
        }/full.png`,
