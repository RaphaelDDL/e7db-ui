    ...
    <main class="column is-12">
      <section class="section-container">
        <div class="section-box">
          ...
          <p>
            EpicSevenDB ("us", "we", or "our") operates the
            https://epicsevendb.com website (the "Service").
          </p>
          ...
          <p>
            If you are located outside Brazil and choose to provide information
            to us, please note that we transfer the data, including Personal
            Data, to Brazil and process it there.
          </p>
          <p>
          ...
          <p>
            EpicSevenDB will take all steps reasonably necessary to ensure that
          ...
          <p>
            EpicSevenDB may disclose your Personal Data in the good faith belief
