        ...
        >
            ...
            <section class='section-container hero-title'>
                <div class='columns is-mobile'>
                    ...
                    <div
                        class='column is-two-fifths hero-thumb'
                        v-lazy-container='{ selector: "img" }'
                    >
                        <img
                            :data-error='`${assetsUrl}/assets/face/small_missing.png`'
            ...
            <section class='section-container'>
                ...
                >
                    ...
                    >
                        <div
                            :class='skillClasses(skill)'
                            class='skill-icon'
                            v-lazy-container='{ selector: "img" }'
                        >
                            <img
                                :data-error='`${assetsUrl}/assets/face/sk_missing.png`'
                        ...
                        >
                            <img
                                :data-src='`${assetsUrl}/dimbreath/buff/${buff}.png`'
                                :key='buff'
                                alt='buff'
                                v-for='buff in skill.buffs'
                            >
                            <img
                                :data-src='`${assetsUrl}/dimbreath/buff/${debuff}.png`'
                                :key='debuff'
                                alt='debuff'
                        ...
                        <div class='skill-sub-desc'>
                            <div
                                ...
                                v-if='skill.soulAcquire'
                            >Acquire {{ skill.soulAcquire }} Soul</div>
                            <div
                                class='skill-soul-acquire'
                                v-if='!skill.soulAcquire && skill.isPassive == true'
                            >Passive</div>
                            <div
                                class='skill-cooldown'
                                v-if='skillCooldown(skill)'
                            >{{ skill.cooldown }} turns</div>
                        </div>
                        ...
                        <div v-if='skill.enhancement && skill.enhancement.length'>
                            ...
                            <ol class='skill-enhance-list'>
                                <li
                                    :class='{
                    "has-resource":
                      enhancement.resources && enhancement.resources.length
                  }'
                                    :key='enhancementindex'
                                    v-for='(enhancement, enhancementindex) in skill.enhancement'
                                >
                                    <!-- handling old array of strings type of hero until all are fixed -->
                                    {{
                                    `${
                                    ...
                                    <div v-if='enhancement.resources && enhancement.resources.length'>
                                        ...
                                        >{{ resource.qty }}x {{ resource.item }}</span>
                                    </div>
                                </li>
                            </ol>
                        </div>
            ...
            <section class='section-container'>
                <tabs
                    :options='{ useUrlFragment: false }'
                    class='section-tabs awakening-tabs'
                >
                    <tab
                            ...
                            <div class='column is-full hero-stats-base'>
                                ...
                                <ul>
                                    ...
                                    <li
                                        ...
                                        v-for='(improvementObject,
                    improvementIndex) in awakening.statsIncrease'
                                    >
                                        <div
                                            :key='improvementObjectKey'
                                            class='columns is-mobile'
                                            v-for='(improvementObjectValue,
                      improvementObjectKey) in improvementObject'
                                        >
                                            <div
                                                class='column is-half hero-stats-type'
                                            >{{ improvementObjectKey | statusName }}</div>
                                            <div
                                                class='column is-half hero-stats-value'
                                            >{{ improvementObjectValue | toPercent }}</div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class='memory-imprint-formation'>
                                <template v-if='heroDetail.memoryImprintFormation'>
                                    <div
                                        ...
                                        v-for='(positionActive,
                    formationPosition) in heroDetail.memoryImprintFormation'
                                    >
                                        <div
                                ...
                                <template v-else>Imprint formation details not available yet.</template>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <ul class='imprint-list'>
                                <template
                                    v-for='(memoryImprint,
                  memoryImprintIndex) in heroDetail.memoryImprint'
                                >
                                    <li
                    ...
                    <div class='hero-stats columns'>
                        <div class='column is-half hero-stats-container-base'>
                            ...
                            <ul>
                                <li class='columns is-mobile'>
                                    ...
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.cp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Attack</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.atk }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Defense</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.def }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Health</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.hp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Speed</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.spd }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.chc }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Damage</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.chd }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effectiveness</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.eff }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effect Resistance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.efr }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Dual Attack Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.base.dac }}%</div>
                                </li>
                            </ul>
                        </div>
                        <div class='column is-half hero-stats-container-50'>
                            ...
                            <ul>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>CP</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.cp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Attack</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.atk }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Defense</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.def }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Health</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.hp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Speed</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.spd }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.chc }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Damage</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.chd }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effectiveness</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.eff }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effect Resistance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.efr }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Dual Attack Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max5.dac }}%</div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class='hero-stats columns'>
                        <div class='column is-half hero-stats-container-60'>
                            ...
                            <ul>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>CP</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.cp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Attack</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.atk }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Defense</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.def }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Health</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.hp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Speed</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.spd }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.chc }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Damage</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.chd }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effectiveness</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.eff }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effect Resistance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.efr }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Dual Attack Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max6.dac }}%</div>
                                </li>
                            </ul>
                        </div>
                        <div class='column is-half hero-stats-container-max'>
                            ...
                            <ul>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>CP</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.cp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Attack</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.atk }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Defense</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.def }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Health</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.hp }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Speed</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.spd }}</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.chc }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Critical Hit Damage</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.chd }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effectiveness</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.eff }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Effect Resistance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.efr }}%</div>
                                </li>
                                <li class='columns is-mobile'>
                                    <div class='column is-half hero-stats-type'>Dual Attack Chance</div>
                                    <div class='column is-half hero-stats-value'>{{ heroDetail.stats.max.dac }}%</div>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        >
            ...
            >
                <div class='section-box'>
                        ...
                        >
                            <a class='columns is-mobile'>
                                <div class='column hero-specialty-icon'>
                                    <img
                                        :data-error='`${assetsUrl}/assets/face/icon_missing.png`'
                                        :data-src='
                      `${assetsUrl}/assets/face/${
                        heroDetail.specialtyChangeName.fileId
                      }/icon.png`
                    '
                                ...
                                <div class='column hero-specialty-description'>
                                    <p class='hero-specialty-name'>
                                        {{
                                        heroDetail.specialtyChangeName.name ||
                                        heroDetail.specialtyChangeName.fileId
                                        }}
                                    </p>
                                </div>
                    ...
                    <hr>
                    <p>
                        <strong class='white'>{{ heroDetail.name }}</strong> has a Specialty
                        Change to
                        <strong class='white'>
                            {{
                            heroDetail.specialtyChangeName.name ||
                        ...
                        </strong>. You need the unit to be level 50 before you can start the
            ...
            <section class='section-container'>
                <div
                    class='section-box hero-illustration'
                    v-lazy-container='{ selector: "img" }'
                >
                    <h1>Illustration</h1>
                    <hr>
                    ...
                    <p>Battle Art:</p>
                    <img
                        :data-error='`${assetsUrl}/assets/face/full_missing.png`'
            ...
            <section
                class='section-container'
                v-if='heroDetail.relations.length'
            >
                <div class='section-box'>
                    <h1>Relations</h1>
                    <hr>
                            ...
                            <a class='columns is-mobile'>
                                <div class='column hero-relationship-icon'>
                                    <img
                                        :data-error='`${assetsUrl}/assets/face/icon_missing.png`'
                                        :data-src='
                      `${assetsUrl}/assets/face/${relation.fileId}/icon.png`
                    '
                                        class='hero-illustration-img hero-illustration-icon'
                                    >
                                </div>
                    ...
                    <hr>
                    <p>
                        Observation: {{ heroDetail.name }} might have more relationships,
                        but only the heroes which we currently have data are present, in
                        order to present you with a link you can click and go to their
                        detail page. As the database grows, the other ones will
...
<script>
    ...
    export default {
        ...
        computed: {
            imageUrls() {
                return {
                    full: `${this.assetsUrl}/assets/face/${this.heroDetail.fileId}/full.png`,
                    small: `${this.assetsUrl}/assets/face/${this.heroDetail.fileId}/small.png`,
                    icon: `${this.assetsUrl}/assets/face/${this.heroDetail.fileId}/icon.png`,
                };
            },
            webpSupport() {
        ...
        methods: {
            ...
            skillImage(skill = {}, skillPos = 1) {
                ...
                return `${this.assetsUrl}/assets/face/${this.heroDetail.fileId}/sk_${skillPos}${passive}.png`;
            },
            skillCooldown(skill = {}) {
