<template>
    <div class="list-filters">
        <div v-if="isVisible">
            ...
            <div class="columns">
                <div class="column is-12">
                    <button class="btn-clear-filters" @click="clearSelection">
        ...
        <h4 v-if="!isVisible" @click="toggleVisibility">&#8595; {{ $t("filters.openFilters") }}</h4>
        <h4 v-if="isVisible" @click="toggleVisibility">&#8593; {{ $t("filters.closeAndClear") }}</h4>
    </div>
</template>
