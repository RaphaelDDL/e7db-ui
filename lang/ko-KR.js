...
export default {
    ...
    about: {
        p1: "EpicSevenDB.com은 에픽세븐의 영웅, 아티팩트, 장비, 아이템 및 퀘스트 등에 대한 정확한 정보를 제공하는 것을 목표로하는 팬들이 함께 만든 웹사이트입니다!",
        p2: "이를 위해 GitHub을 통해 피드백, 아이디어 및 게임 데이터를 수신하며 전 세계의 에픽세븐 커뮤니티의 도움을 받고 있습니다. 저희에게 도움을 주고 싶다면 아래 링크를 참조해주세요. 크고 작은 모든 도움에 감사드립니다!",
    },
    classes: {
        knight: "기사",
        warrior: "전사",
